import { DictionaryNew } from "./dictionary-new";

export class RdfcsaNew {
  /**
   * Creates the rdfcsa datastructure
   * @param {string[][]} tripleList
   */
  constructor(tripleList) {
    this.dictionary = new DictionaryNew(tripleList);
    this.dictionary.createDictionariesNew(tripleList);
    const tArray = this.#constructTArraysNew(tripleList);
  ...
  #constructTArraysNew(tripleList) {
